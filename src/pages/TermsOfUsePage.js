...
const TermsOfUsePage = () => {
  ...
  return (
    <Container>
      <Typography style={styles.heading}>Terms of Use</Typography>
      <div>
        <p>
          These Terms of Use apply in connection with any websites, online
          services, and/or applications owned or operated by
          <span style={{ color: "red", fontWeight: "bold" }}>
            AdvancedInsonline.com LLC, a Florida LLC (“we,” “us,” or “our”),
        ...
        <ul>
          <li>
            ...
            <a href="/">www.advancedInsonline.com</a> and any other website
            owned by us upon which these Terms of Use are linked (collectively,
            the “Site”); and
          </li>
          <li>
            ...
            licensees through, and all other content within, the Site (all of
        ...
        <ol>
          ...
          <p>
            ...
            PRECENDENCE OVER THESE TERMS IN THE EVENT OF A CONFLICT BETWEEN SUCH
            AGREEMENT AND THESE TERMS. By entering the Site or using the
            Services, you acknowledge and agree to all terms, conditions, and
            rules stated in these Terms. You are not permitted to use the Site
            or Services if you do not agree to be legally bound by these Terms.
            Please read these Terms carefully. We may, in our sole discretion,
            modify the Terms from time to time and we reserve the right to make
            changes at any time, without notice or obligation, to any of the
            Terms, Site, or Services. By entering the Site or using the
            Services, you acknowledge and agree that you shall be bound by any
            such revisions. We suggest periodically visiting this page of the
            Site to review these Terms.
          </p>
          ...
          <p>
            ...
            without regard to conflicts of laws principles. If you are not a
            member of the intended audience, you are prohibited from accessing
            the Site or using the Services. We may assign our rights and
            obligations under these Terms, including in connection with a
          ...
          <p>
            ...
            up-to-date, we cannot guarantee 100% accuracy. WE THEREFORE
            ...
            FITNESS FOR A PARTICULAR PURPOSE AND ALL WARRANTIES REGARDING
            SECURITY, CURRENCY, CORRECTNESS, QUALITY, ACCURACY, COMPLETENESS,
            RELIABILITY, PERFORMANCE, TIMELINESS, OR CONTINUED AVAILABILITY WITH
            RESPECT TO THE SITE AND CONTENT. To the extent any jurisdiction does
            not allow the exclusion of certain warranties, some of the above
            exclusions do not apply. The Site also offers job opening
            information and provides ways for you to apply for positions. You
            understand that nothing contained on the Site constitutes an offer
            of employment by us. If you are a consumer seeking insurance
            products, please be aware that we are not an insurance company or an
            insurance agent. We help connect individuals and businesses with
            companies that may be able to provide insurance products. We do not
            charge individuals or businesses to submit inquiries regarding
            obtaining insurance through our Site/Services, instead, we receive a
            payment from the companies with whom we connect potential buyers. We
            do not endorse or recommend any particular insurance agent, insurer,
            or Insurance Service, nor do we recommend any particular insurance
          ...
          <li>Password and Account Security</li>
          <p>
            ...
            and update us if this information changes. If you create an account,
            we will assign you, or allow you to select, a password. You must
            keep your password confidential, and you may not permit any other
            person to use your password or your account for any purpose. You
            will be responsible for all use of your password, including, without
            limitation, any use by any authorized or unauthorized third party.
            You must notify us immediately if you believe your password may have
            been used by any unauthorized person or entity. For security
            purposes, we recommend you change your password often. Under no
            circumstance should you respond to a request for your password. Our
            employees will never ask for your password. You must notify us
            immediately if you receive such a request. We reserve the right to
            suspend or terminate your use of the Site/Services if we believe
            that your password is being used without permission or otherwise in
            a manner that may disrupt the Site/Services.
          </p>
          <li>Consent for Communications</li>
          <p>
            ...
            marketing calls/text messages at that number using an autodialer
            AND/OR PRErecorded messages. You also acknowledge that your consent
            to receive these marketing communications is not required to
            purchase any goods or services. STANDARD MESSAGE AND DATA RATES MAY
            APPLY. If you provide your telephone number to us via the Site or
            Services AND GIVE CONSENT FOR COMMUNICATIONS FROM THIRD PARTIES WITH
            WHOM WE MAY SHARE YOUR INFORMATION, you give your electronic
            signature and consent for us AND SUCH THIRD PARTIES to send you
            marketing calls/text messages at that number using an autodialer
            AND/OR PRErecorded messages. You also acknowledge that your consent
            to receive these marketing communications is not required to
            purchase any goods or services. STANDARD MESSAGE AND DATA RATES MAY
            APPLY. IF YOU PARTICIPATE IN OUR SMS TEXTING PROGRAM, YOU ALSO AGREE
            TO OUR SMS TEXTING PROGRAM TERMS AND CONDITIONS LOCATED AT THE END
            OF THESE TERMS.
          </p>
          ...
          <p>
            ...
            be the trademarks and the property of their respective owners. You
            acknowledge and agree that information and services available on the
            Site/Services are protected by copyrights, trademarks, service
            ...
            derivative works from the Site, Services, or Content. Without
            waiving any of the foregoing rights, you may print or download
            information from the Site for your own personal, non-commercial home
            use, provided that you keep intact all copyright and other
            proprietary notices. Systematic retrieval of information from the
            Site/Services to create or compile, directly or indirectly, a
          ...
          <p style={{ color: "red", fontWeight: "bold" }}>
            AdvancedInsonline.com
          </p>
          <p style={{ color: "red", fontWeight: "bold" }}>Attn: DMCA</p>
          <p style={{ color: "red", fontWeight: "bold" }}>
            17501 Biscayne Boulevard, STE 540
          </p>
          <p style={{ color: "red", fontWeight: "bold" }}>Aventura, FL 33160</p>
          <p style={{ color: "red", fontWeight: "bold" }}>
            Email address: info@advancedInsonline.com
          </p>
          <p style={{ color: "red", fontWeight: "bold" }}>
            Phone number: (844-658-4626)
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              infringed, or, if there are multiple copyrighted works, a list of
              such works;
            </li>
            <li>
            ...
            <p>
              ...
              notice must also contain a statement that, under penalty of
              perjury, the person submitting the notice is authorized to act on
              your behalf.
            </p>
          </ul>
          <li>Submissions</li>
          <p>
            ...
            literary works. We are not responsible for the content of
            Submissions provided by you or any other user. We do not necessarily
            endorse any opinion contained in such material. We make no
            warranties or representations, express or implied, about
            Submissions, including as to their legality or accuracy. We reserve
            the right, but are under no obligation, to refuse, remove, or edit
            any of your Submissions, or to restrict, suspend, or terminate your
            access to all or any part of the Site/Services, and we may do this
            with or without giving you any prior notice. We may link Submissions
            or parts of Submissions to other material, including material
            submitted by other users or created by us or third parties. We may
            use Submissions for our business purposes, for example, to examine
            trends or categories or to promote, market, or advertise our
            services or the products and services of others. You acknowledge
            that we may commercially benefit from use of your Submissions. Each
            time you make a Submission, you represent and warrant as follows:
          </p>
          <ol type="a">
            <li>
              You own your Submission or have the right to submit it, and in
              submitting it you will not be infringing any rights of any third
              party, including intellectual property rights (such as copyright
              or trademark), privacy or publicity rights, rights of
              confidentiality, or rights under contract.
            </li>
            <li>
              Your Submission is not illegal, obscene, defamatory, threatening,
              pornographic, harassing, hateful, racially or ethnically
              offensive, and does not encourage conduct that would be considered
              a criminal offense, and does not give rise to civil liability,
              violate any law, or is otherwise deemed inappropriate.
            </li>
            <li>
              Your Submission does not identify any individual (including by way
              of name, address, picture, or video) under the age of 18 and if
            ...
            <li>
              You will not collect usernames and/or email addresses of others
            ...
            <li>
              ...
              non-public areas of the Site, our computer systems, or the
              technical delivery systems of our service providers.
            </li>
            <li>
          ...
          <p>
            ...
            indemnify us and our Affiliates (as defined below) for all claims
            arising from or in connection with any claims to any rights in your
            Submission or any damages arising from your Submission.
          </p>
          ...
          <p style={{ color: "red", fontWeight: "bold" }}>
            ...
            to the state or federal courts of Lakeland County, Florida and all
          ...
          <p>
            ...
            to which these Terms do not apply. We provide links as a convenience
            and the inclusion of the link does not imply that we endorse or
            accept any responsibility for the content on those sites. We are not
            responsible for content including but not limited to claims,
            representations, warranties, offers, illustrations, names, or
            endorsements on any other sites. Further, we are not, directly or
            indirectly, implying any approval, association, sponsorship,
            endorsement, or affiliation with the linked site, unless
            specifically stated therein. Your linking to any other off-site
            pages or other sites is at your own risk. We recommend that you
            review any terms of use statement and privacy policy before using
            any other linked site, including social media sites.
          </p>
